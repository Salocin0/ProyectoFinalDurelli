        ...
        <article key={producto.id} >
            <div className='cardcarrito'>
                ...
                <div className='statscontcarrito'>
                    <div className='cardcarrito-stats'>
                        Precio: {producto.price}$ X {producto.cantidad}<FontAwesomeIcon icon={faArrowRight}/>Subtotal: {(producto.price * producto.cantidad).toFixed(2)}$
                    </div>
